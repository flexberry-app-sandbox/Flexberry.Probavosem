...
namespace IIS.Probavosem
{
    ...
    [View("ДолжностиE", new string[] {
            ...
            "Карта.КодКарты"})]
    [MasterViewDefineAttribute("ДолжностиE", "Карта", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "КодКарты")]
    ...
    public class Должности : ICSSoft.STORMNET.DataObject
    {
        ...
        /// Должности.
        /// </summary>
        // *** Start programmer edit section *** (Должности.Карта CustomAttributes)

        // *** End programmer edit section *** (Должности.Карта CustomAttributes)
        ...
        public virtual IIS.Probavosem.Карта Карта
        {
            get
            {
                // *** Start programmer edit section *** (Должности.Карта Get start)

                // *** End programmer edit section *** (Должности.Карта Get start)
                IIS.Probavosem.Карта result = this.fКарта;
                // *** Start programmer edit section *** (Должности.Карта Get end)

                // *** End programmer edit section *** (Должности.Карта Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Должности.Карта Set start)

                // *** End programmer edit section *** (Должности.Карта Set start)
                this.fКарта = value;
                // *** Start programmer edit section *** (Должности.Карта Set end)

                // *** End programmer edit section *** (Должности.Карта Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДолжностиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДолжностиE", typeof(IIS.Probavosem.Должности));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДолжностиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДолжностиL", typeof(IIS.Probavosem.Должности));
                }
            }
        }
    }
